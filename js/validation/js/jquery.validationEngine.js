        ...
        _custom: function (field, rules, i, options) {
            ...
            if (rule["regex"]) {
                ...
                if (!pattern.test(field.val())) {
                    //        return options.allrules[customRule].alertText;  // dont delete ----------------
                    switch (rule["rule"]) {
                            ...
                            if (field.val().toString().trim().length > 0) {
                                ...
                                if (split.length == 2) {
                                    ...
                                    if (domain.length == 2 && domain[0] != "") {
                                        ...
                                        return domain[0] + " not a valid domain";
                                    }
                                } else if (split.length != 2 && split.length > 0) {
                                    return "validation for spliting @ ";
                                }
                            }
                            ...
                            if (field.val().trim().length > 0) {
                                ...
                                if (protocol == "https://") {
                                    ...
                                    if (protocol == "http://") {
                                        ...
                                        if (!protocol[0].trim()) {
                                            return " * remove the space in the protocol";
                                        } else {
                                            return " * " + field.val() + " its not a valid protocol";
                                        }
                                    }
                                    ...
                                    for (var i = 0; i < inputString.length; i++) {
                                        ...
                                        if (check == null) {
                                            ...
                                            if (!inputString[i].trim()) {
                                                return "  * Remove the space after " + prvCheck;
                                            }
                                        }
